...
class RecipeModel<T> extends Model {
  ...
  Map<String, dynamic> toMap({bool persist = false}) {
    ...
    map.addAll({
      ...
      'ibu': this.ibu,
      'ebc': this.ebc,
      'fermentables': Quantity.serialize(fm.FermentableModel.quantities(this._fermentables)),
      'hops': Quantity.serialize(hm.HopModel.quantities(this._hops)),
      'miscellaneous': Quantity.serialize(mm.MiscModel.quantities(this._misc)),
      'yeasts': Quantity.serialize(YeastModel.quantities(this._yeasts)),

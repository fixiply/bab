...
class GradientRangeSliderTrackShape extends RangeSliderTrackShape {
  ...
  void paint(
    ...
    assert(sliderTheme.rangeThumbShape != null, 'sliderTheme.rangeThumbShape is required');
    assert(sliderTheme.trackHeight != null && sliderTheme.trackHeight! > 0, 'sliderTheme.trackHeight != null and sliderTheme.trackHeight! > 0 are required');
    ...
    final ColorTween inactiveTrackColorTween = darkenInactive ? ColorTween(
